 ...
 */
public class PharmacyList implements localDataInterface {
    private ArrayList<Pharmacy> pList = new ArrayList<Pharmacy>();


    public PharmacyList(Context c){
        try {
...
//                }
    ...
    public String loadJSONFromAsset(Context c) {
        ...
        try {
            ...
            is = c.getAssets().open("pharmacyjson.json");
